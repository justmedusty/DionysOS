...
## I have got it working on bare hardware on my main laptop as well as my chromebook. My main laptop required quite a bit more changes to get it working compared to the chromebook. Notably on my main laptop an infinite loop was triggered in the MADT
