...
Running `make run-x86` will build the kernel and a bootable ISO (equivalent to make all) and then run it using `qemu` (if installed). Future development will support a make run-riscv directive.
